         ...
         <table class="table table-bordered">
            ...
            <tbody>
               <?php if (count($listcart) > 0) : ?>
                  <?php $stt = 1; ?>
                  <?php foreach ($listcart as $yyyy) : ?>
                     <?php $money_item = $yyyy['qty'] * $yyyy['price']; ?>
                     <tr>
                        <td class="text-center align-middle"><?= $stt; ?></td>
                        <td>
                           <img class="img-fluid" src="public/images/product/<?= $yyyy['image']; ?>" alt="<?= $yyyy['image']; ?>">
                        </td>
                        <td class="align-middle"><?= $yyyy['name']; ?></td>
                        <td class="text-center align-middle"><?= number_format($yyyy['price']); ?></td>
                        <td class="text-center align-middle">
                           <div class="input-group mb-3">
                              <input type="number" value="<?= $yyyy['qty']; ?>" min=0 name="qty[<?= $yyyy['id']; ?>]" id="qty" style="width:60px">
                        ...
                        <td class="text-center align-middle">
                           <a href="index.php?option=cart&deletecart=<?= $yyyy['id']; ?>" class="btn btn-sm btn-main">
            ...
            <tfoot>
               <tr>
                  <td colspan="5">
                     <button class="btn btn-main type=sumbit">Cập nhật</button>
