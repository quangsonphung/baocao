...
$slug = $_REQUEST['slug'];
$pro = Product::where([['slug', '=', $slug], ['status', '=', 1]])->first();
$title = $pro->name;
...
$list_other = Product::where([['id', '!=', $pro->id], ['status', '=', 1]])
   ...
   <div class="container">
      <div class="row">
         ...
         <div class="col-md-6">
            ...
            <h3 class="fs-5"><?= MyClass::word_limit($pro->detail, 3); ?>
            </h3>
            ...
            <div class="product-category mt-3">
               <div class="row product-list">
                  <?php foreach ($list_other as $product) : ?>
                     <div class="col-6 col-md-3 mb-4"><?php require 'views/frontend/product-item.php'; ?></div>
                  <?php endforeach; ?>
               </div>
            </div>
         </div>
